  ...
  const achievements = [
    {
      ...
      image: "/assets/2025_Duolingo_Review.jpeg",
    },
    {
      id: 2,
      days: 275,
              ...
              <div className="card card-hover overflow-hidden h-full">
                ...
                <div className="relative h-48 sm:h-56">
                  <Image
                    ...
                    alt={`${achievement.tier} – ${achievement.days}-day streak`}
                    fill
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div>
                      ...
                      <p className="text-secondary-600 text-sm">
                        Language: <span className="font-medium">{achievement.language}</span>
                      </p>
                    </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2 mb-4">
                    <span className="px-2.5 py-1 rounded-lg text-xs bg-secondary-100 text-secondary-700">
                      Daily Goal: High
                    </span>
                    <span className="px-2.5 py-1 rounded-lg text-xs bg-accent-100 text-accent-700">
                      Last updated: {achievement.lastUpdated}
                    </span>
                  </div>
