...
const Home = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (currentScrollY > 500) { // Show nav after scrolling 100px
        setShowNav(true);
      } else {
        setShowNav(false);
      }
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Static Nav Bar */}
      <nav className={`w-full bg-yellow-100 fixed top-0 left-0 right-0 z-50 shadow-md transition-all duration-300 transform ${showNav ? '-translate-y-full' : 'translate-y-0'
        }`}>
        <div className="container mx-auto px-4">
          ...
          {isOpen && (
            <div ref={menuRef} className="md:hidden flex flex-col gap-4 bg-yellow-200 p-4 rounded-lg shadow-lg">
      ...
      {/* Animated Nav Bar */}
      <nav className={`w-full bg-yellow-100 fixed top-0 left-0 right-0 z-50 shadow-md transition-all duration-300 transform ${showNav ? 'translate-y-0' : '-translate-y-full'
        }`}>
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            {/* Logo / Branding */}
      ...
      <div className="pt-16">
        <div className="min-h-screen flex flex-col lg:flex-row justify-around items-center px-6" id="home" data-aos="fade-up">
        ...
        {/* Honors */}
        <div className="h-auto p-10 bg-gray-100 rounded-lg text-black" id="honors" data-aos="fade-up">
        ...
        {/* Experience */}
        <div className="h-auto" id="experience" data-aos="fade-right">
        ...
        {/* Technical workshop */}
        <WorkshopComponent workshop_img={workshop_img} breakpointColumnsObj={breakpointColumnsObj} data-aos="zoom-in" />
        ...
        {/* Education */}
        <section id="education" className="bg-white text-black py-16 px-6" data-aos="fade-left">
        ...
        <div className="h-auto p-6" id="projects" data-aos="fade-up">
